...
object Metrics extends Metrics {
  ...
  val timers = Map(
    MetricsEnum.TAVC_SUBSCRIPTION -> MetricsRegistry.defaultRegistry.timer("tavc-subscription-response-timer")
  )

  val successCounters = Map(
    MetricsEnum.TAVC_SUBSCRIPTION -> MetricsRegistry.defaultRegistry.counter("tavc-subscription-success-counter")
  )

  val failedCounters = Map(
    MetricsEnum.TAVC_SUBSCRIPTION -> MetricsRegistry.defaultRegistry.counter("tavc-subscription-failed-counter")
  )
